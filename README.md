...
### [2025] 오픈소스 기초 프로젝트
- 국민 참여형 법안 피드백 대시보드 개발
- React · FastAPI 기반 팀 프로젝트 진행
...
### [2026] 멋쟁이사자처럼 해커톤 (진행중)
- 주야간보호 전용 AI 생애여정 음악 지도 서비스 "똑똑(TokTok)" 기획 및 프론트엔드 개발
- AI 기반 생애 인터뷰, 맞춤형 AI 작곡 및 일지 자동 생성 기능 구현 참여
...
국회 Open API를 활용해 법안 정보를 제공하고, 사용자가 법안에 대해 의견을 남길 수 있는 국민 참여형 웹 서비스.

### 주요 기능
- 국회 Open API 기반 법안 목록 및 상세 정보 조회
- 공포 법안 / 심사 중 법안 분류 제공
- 법안 검색 및 필터 기능
- 법안별 찬반 투표 기능
- 댓글 및 토론방 기능
...
- Backend : FastAPI
- Database : MySQL
- Tools : Figma · GitHub · ERD Cloud

🔗 [GitHub Repository](https://github.com/ryu-min-ji/MGP)

---

## ⚽ We Play - 스포츠 커뮤니티 웹 서비스

스포츠 팬들이 경기 정보 확인, 커뮤니티 활동, 실시간 채팅을 한 곳에서 이용할 수 있는 스포츠 커뮤니티 웹 서비스.
...
- 댓글 / 대댓글 기능
- Socket.io 기반 실시간 채팅
- TheSportsDB API 기반 KBO 경기 일정 조회
- 마이페이지 및 프로필 이미지 변경
...
🔗 [GitHub Repository](https://github.com/ryu-min-ji/sport-community)
...
🔗 [GitHub Repository](https://github.com/CBNU-likelion/ideathon-4th-frontend)
